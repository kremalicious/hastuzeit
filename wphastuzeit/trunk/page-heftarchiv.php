...
<?php get_header(); ?>
			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<p><a href="http://hastuzeit.de/readiculum/" title="READiculum"><img class="aligncenter" src="http://hastuzeit.de/uploads/2009/12/readiculum-banner.png" alt="readiculum-banner" width="570" height="58"/></a></p>
