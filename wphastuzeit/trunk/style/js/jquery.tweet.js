    ...
    return this.each(function(){
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          var date = '<a class="tweetdate" href="http://twitter.com/'+item.from_user+'/statuses/'+item.id+'" title="view tweet on twitter">'+relative_time(item.created_at)+' |</a><a class="tweetdate" href ="http://twitter.com/'+item.from_user+'">@'+item.from_user+'</a>';
